...
class ServerCog(commands.Cog, name="Server Specific"):
	...
	async def roll_members_is_rigged(self, ctx):
		...
		await ctx.reply(embed=discord.Embed(title="It isn't rigged™", description="This bot is open source on [this github repository](https://github.com/SmallPepperZ/SachiBotPy/blob/development/cogs/server_specific.py#L56). I've highlighted the line where the randomness takes place to enhance your viewing experience. I encourage you to let me know of any issues you find in the code",color=embedcolor))
